            ...
            <div class="w-full max-w-lg">
                ...
                <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-8 mb-4">
                    <div class="mb-6 pb-4 border-b border-slate-100">
                        <h1 class="text-xl font-bold text-slate-800 tracking-tight">Tambahkan Karyawan Baru</h1>
                        <p class="text-xs text-slate-400 mt-1">Daftarkan data akun kredensial awal untuk pengguna baru di
                            sistem.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('invites.store') }}">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label
                                    class="block text-[10px] font-extrabold text-slate-400 uppercase tracking-wider mb-1.5">Password
                                    Awal</label>
